...
class HumanoidPose(object):
  ...
  def Slerp(self, frameFraction, frameData, frameDataNext, bullet_client):
    ...
    self._basePos = [0, 0, 0]
    self._baseLinVel = [0, 0, 0]
    self._baseOrn = (0.5023940205574036, -0.4802530109882355, -0.48765701055526733, 0.528344988822937)
    self._baseAngVel = [0, 0, 0]
...
class Humanoid(object):
  ...
  def RenderReference(self, t):
    ...
    self._rightShoulderJointAnglesList.append(pose._rightShoulderRot)
  ...
  def ApplyPose(self, pose, initializeBase, initializeVelocities, humanoid, bc):
    ...
    print('applypose-- ', pose._rightShoulderRot)
    print('applypose-- ', pose._rightElbowRot)
