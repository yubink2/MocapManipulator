...
parser.add_argument('--action', default='Greeting', type=str, help='name of the action.')
...
bc.loadURDF("plane.urdf", [0, -0.04, 0], y2zOrn)  # ground floor
bc.loadURDF("./urdf/cube_0.urdf", [-1, 0.3, 0.0], y2zOrn)  # cube bed

humanoid = Humanoid(bc, motion, [0, 0.3, 0])  #This is the coordinates of the initial position
# print("BASE POS AND ORI", p.getBasePositionAndOrientation(humanoid._humanoid))
